...
INSERT INTO `cms_config` VALUES (42, 'tte', 'tt', '2020-03-31 19:37:16', '2020-03-31 19:37:16', 'test', 'basic', 44);
...
-- ----------------------------
INSERT INTO `cms_theme` VALUES (44, 'Hello World !', '2020-03-09 09:37:05', '2020-04-03 17:03:13', 1, 1);
...
CREATE TABLE `cms_theme_layout`  (
  ...
  `review` tinyint(255) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `cms_theme_layout` VALUES (20, '布局', '2020-03-09 09:43:44', '2020-04-01 15:55:14', 44, '{\"header\":[\"116\"],\"top\":[\"117\"],\"footer\":[\"115\",\"114\"]}', 0);
INSERT INTO `cms_theme_layout` VALUES (22, '预览布局', '2020-04-01 15:55:07', '2020-04-03 17:22:24', 44, '{\"header\":[\"116\"],\"top\":[],\"footer\":[\"114\"]}', 1);
