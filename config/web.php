...
$config = [
    ...
    'modules' => [
        'cms-frontend' => [
            'class' => 'app\modules\cms\frontend\Module',
        ],
        'cms-backend' => [
            'class' => 'app\modules\cms\backend\Module',
        ],
        'plugin-frontend' => [
            'class' => 'app\modules\plugin\frontend\Module',
        ],
        'plugin-backend' => [
            'class' => 'app\modules\plugin\backend\Module',
        ]
    ],
];
