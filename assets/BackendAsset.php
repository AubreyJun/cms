...
class BackendAsset extends AssetBundle
{
    ...
    public $js = [
        ...
        'static/backend/lib/codemirror/lib/formatting.js',
        'static/backend/lib/codemirror/mode/javascript/javascript.js',
        'static/backend/lib/codemirror/mode/xml/xml.js',
        'static/backend/lib/codemirror/mode/css/css.js',
        'static/backend/lib/codemirror/mode/htmlmixed/htmlmixed.js',
