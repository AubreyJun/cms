    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        <h4 class="card-title">页面导航</h4>
                    </div>
                    <div class="col-lg-6 text-right">
                        <form class="form-inline" style="float: right;">
                            <div class="form-group">
                                <button type="button" class="btn btn-primary btn-xs"
                                        onclick="window.location.href='index.php?r=cms-backend/navigation/add'"><i
                                            class="fa fa-plus"></i>
                                </button>
                            </div>
                        </form>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    foreach ($navgation as $item) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="text-primary mr-1"
                                   href="index.php?r=cms-backend/navigation/update&id=<?php echo $item['object']['id']; ?>">
                                    <i class="fa fa-pencil fa-lg"></i>
                                </a>
...
<script>
    ...
    function deleteItem(id) {
        doConfirm('删除分类目录？',function () {
            window.location.href = "index.php?r=cms-backend/navigation/delete&id="+id;
        });
    }
</script>
