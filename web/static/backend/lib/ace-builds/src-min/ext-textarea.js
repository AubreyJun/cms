define("ace/theme/textmate", ["require", "exports", "module", "ace/lib/dom"], function (e, t, n) {
...
}), define("ace/ext/textarea", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/lib/net", "ace/ace", "ace/theme/textmate"], function (e, t, n) {
    "use strict";
    ...
    function c(e, t, n, r, i) {
        ...
        var s = e.getSession(), o = e.renderer;
    ...
    function h(e, n, i) {
        ...
        var s = null, o = {
            ...
            showGutter: s,
            fontSize: {"10px": "10px", "11px": "11px", "12px": "12px", "14px": "14px", "16px": "16px"},
        ...
        for (var l in t.defaultOptions) a.push("<tr><td>", o[l], "</td>"), a.push("<td>"), f(a, l, u[l], i.getOption(l)), a.push("</td></tr>");
    ...
    t.transformTextarea = function (e, n) {
        var s = e.autofocus || document.activeElement == e, u, l = f(e, function () {
            return u.getValue()
        });
        ...
        return r.addListener(d, "mousemove", function (e) {
            ...
            l.style.zIndex = 1e5;
            var t = l.getBoundingClientRect(), n = t.width + t.left - e.clientX, i = t.height + t.top - e.clientY;
