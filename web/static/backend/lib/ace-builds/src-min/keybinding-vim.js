define("ace/keyboard/vim", ["require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/dom", "ace/lib/oop", "ace/lib/keys", "ace/lib/event", "ace/search", "ace/lib/useragent", "ace/search_highlight", "ace/commands/multi_select_commands", "ace/mode/text", "ace/multi_select"], function (e, t, n) {
    "use strict";
    ...
    function T(e) {
        e.setOption("disableInput", !0), e.setOption("showCursorWhenSelecting", !1), v.signal(e, "vim-mode-change", {mode: "normal"}), e.on("cursorActivity", Zn), rt(e), v.on(e.getInputField(), "paste", _(e))
    }

    function N(e) {
        e.setOption("disableInput", !1), e.off("cursorActivity", Zn), v.off(e.getInputField(), "paste", _(e)), e.state.vim = null
    }
    ...
    function Xt(e, t, n) {
        ...
        e.setSelections(i.ranges, i.primary), er(e)
    }
    ...
    function Xn(e) {
        ...
        i || (e.off("change", Yn), v.off(e.getInputField(), "keydown", rr)), !i && t.insertModeRepeat > 1 && (ir(e, t, t.insertModeRepeat - 1, !0), t.lastEditInputState.repeatOverride = t.insertModeRepeat), delete t.insertModeRepeat, t.insertMode = !1, e.setCursor(e.getCursor().line, e.getCursor().ch - 1), e.setOption("keyMap", "vim"), e.setOption("disableInput", !0), e.toggleOverwrite(!1), r.setText(s.changes.join("")), v.signal(e, "vim-mode-change", {mode: "normal"}), n.isRecording && Qn(n)
    }
    ...
    function Jn(e, t, n, r) {
        ...
        if (r == ":") {
            i.keyBuffer[0] && zn.processCommand(e, i.keyBuffer[0]), n.isPlaying = !1;
            return
        }
        ...
        for (var u = 0; u < s.length; u++) {
            ...
            while (a) {
                ...
                if (t.insertMode) {
                    ...
                    it.macroModeState.lastInsertModeChanges.changes = c, sr(e, c, 1), Xn(e)
                }
            }
        }
        n.isPlaying = !1
    ...
    function rr(e) {
        function i() {
            return n.maybeReset && (n.changes = [], n.maybeReset = !1), n.changes.push(new nr(r)), !0
        }
    ...
    function ir(e, t, n, r) {
        ...
        t.inputState = o, t.insertMode && !r && Xn(e), i.isPlaying = !1
    }
    ...
    function sr(e, t, n) {
        ...
        for (var o = 0; o < n; o++) {
            ...
            for (var u = 0; u < t.length; u++) {
                var a = t[u];
                if (a instanceof nr) v.lookupKey(a.keyName, "vim-insert", r); else if (typeof a == "string") {
                    var f = e.getCursor();
    ...
    function ur(e, t, n) {
        t.length > 1 && t[0] == "n" && (t = t.replace("numpad", "")), t = or[t] || t;
        var r = "";
    ...
    function fr(e) {
        ...
        return Object.keys(e).forEach(function (n) {
            var r = e[n];
            Array.isArray(r) ? r = r.slice() : r && typeof r == "object" && r.constructor != Object && (r = fr(r)), t[n] = r
            ...
            e.operation(function () {
                e.ace.forEachSelection(function () {
                    ...
                    var s = e.getCursor("head"), o = e.getCursor("anchor"), a = Mt(s, o) ? 0 : -1,
                        f = Mt(s, o) ? -1 : 0;
                    s = Tt(s, 0, a), o = Tt(o, 0, f), e.state.vim.sel.head = s, e.state.vim.sel.anchor = o, r = ar(e, t, n), i.$desiredColumn = e.state.vim.lastHPos == -1 ? null : e.state.vim.lastHPos, e.virtualSelectionMode() && (e.state.vim = fr(u))
                }), e.curOp.cursorActivity && !r && (e.curOp.cursorActivity = !1)
            }, !0)
        }
        return r && !i.visualMode && !i.insert && i.visualMode != e.somethingSelected() && tr(e, i, !0), r
    }

    function hr(e, t) {
        t.off("beforeEndOperation", hr);
    ...
    v.Pos = function (e, t) {
        ...
        if (t.fallthrough) {
            if (!Array.isArray(t.fallthrough)) return pr(e, t.fallthrough, n);
            for (var i = 0; i < t.fallthrough.length; i++) {
                var s = pr(e, t.fallthrough[i], n);
                if (s) return s
            }
        }
    ...
    var it, ot, ut = {
        ...
        defineEx: function (e, t, n) {
            ...
            Un[e] = n, zn.commandMap_[t] = {name: e, shortName: t, type: "api"}
        },
        ...
        findKey: function (e, t, n) {
            ...
            function s() {
                if (t == "<Esc>") return ft(e), r.visualMode ? Jt(e) : r.insertMode && Xn(e), !0
            }
    ...
    var dt = {
        matchCommand: function (e, t, n, r) {
            ...
            function r(t) {
                it.exCommandHistoryController.pushInput(t), it.exCommandHistoryController.reset(), zn.processCommand(e, t)
            }
            ...
            n.type == "keyToEx" ? zn.processCommand(e, n.exArgs.input) : t.visualMode ? Mn(e, {
                onClose: r,
                prefix: ":",
                value: "'<,'>",
                onKeyDown: i,
        ...
        change: function (e, t, n) {
            ...
            } else if (t.fullLine) u.ch = Number.MAX_VALUE, u.line--, e.setSelection(o, u), i = e.getSelection(), e.replaceSelections(""), r = o; else {
                i = e.getSelection();
                var h = gt("", n.length);
        ...
        jumpListWalk: function (e, t, n) {
            ...
            if (r == "eol") s = S(s.line, Ht(e, s.line)); else if (r == "charAfter") s = Tt(s, 0, 1); else if (r == "firstNonBlank") s = vt.moveToFirstNonWhiteSpaceCharacter(e, s); else if (r == "startOfSelectedArea") {
                if (!n.visualMode) return;
            ...
            e.setOption("disableInput", !1), t && t.replace ? (e.toggleOverwrite(!0), e.setOption("keyMap", "vim-replace"), v.signal(e, "vim-mode-change", {mode: "replace"})) : (e.toggleOverwrite(!1), e.setOption("keyMap", "vim-insert"), v.signal(e, "vim-mode-change", {mode: "insert"})), it.macroModeState.isPlaying || (e.on("change", Yn), v.on(e.getInputField(), "keydown", rr)), n.visualMode && Jt(e), qt(e, s, o)
            ...
            if (!r) return;
            var i = t.repeat;
            i && t.repeatIsExplicit ? n.lastEditInputState.repeatOverride = i : i = n.lastEditInputState.repeatOverride || i, ir(e, n, i, !1)
        }, indent: function (e, t) {
    ...
    Rn.prototype = {
        processCommand: function (e, t, n) {
            ...
            try {
                Un[l](e, u), (!f || !f.possiblyAsync) && u.callback && u.callback()
            } catch (a) {
                throw Ln(e, a), a
            }
    ...
    var Un = {
        colorscheme: function (e, t) {
            ...
            var d = 0, v = function () {
                if (d < l.length) {
                    var t = l[d] + u;
                    zn.processCommand(e, t, {callback: v})
                }
                d++
            };
            v()
            ...
            if (r.length) i = r[0], s = r[1], i && i[i.length - 1] === "$" && (i = i.slice(0, i.length - 1) + "\\n", s = s ? s + "\n" : "\n"), s !== undefined && (Z("pcre") ? s = Cn(s) : s = Tn(s), it.lastSubstituteReplacePart = s), o = r[2] ? r[2].split(" ") : []; else if (n && n.length) {
                Ln(e, "Substitutions should be of the form :s/pattern/replace/");
                return
            }
            o && (u = o[0], a = parseInt(o[1]), u && (u.indexOf("c") != -1 && (f = !0, u.replace("c", "")), u.indexOf("g") != -1 && (l = !0, u.replace("g", "")), i = i.replace(/\//g, "\\/") + "/" + u));
            if (i) try {
                Dn(e, i, !0, !0)
            } catch (c) {
    ...
    var or = {
        ...
        pagedown: "PageDown",
        enter: "CR"
    }, ar = x.handleKey.bind(x);
    x.handleKey = function (e, t, n) {
        return e.operation(function () {
            return ar(e, t, n)
        }, !0)
    }, t.CodeMirror = v;
    var cr = x.maybeInitVimState_;
    t.handler = {
        $id: "ace/keyboard/vim", drawCursor: function (e, t, n, r, s) {
            ...
            var s = e.editor, o = s.state.cm, u = cr(o);
            if (r == -1) return;
            ...
            if (t == -1 || t & 1 || t === 0 && n.length > 1) {
                var l = u.insertMode, h = ur(t, n, i || {});
                u.status == null && (u.status = "");
                var p = lr(o, h, "user");
                u = cr(o), p && u.status != null ? u.status += h : u.status == null && (u.status = ""), o._signal("changeStatus");
                if (!p && (t != -1 || l)) return;
                return {command: "null", passEvent: !p}
            }
        }, attach: function (e) {
            function n() {
                var n = cr(t).insertMode;
            ...
            e.state || (e.state = {});
            var t = new v(e);
            e.state.cm = t, e.$vimModeHandler = this, v.keyMap.vim.attach(t), cr(t).status = null, t.on("vim-command-done", function () {
                if (t.virtualSelectionMode()) return;
                cr(t).status = null, t.ace._signal("changeStatus"), t.ace.session.markUndoGroup()
        ...
        e.vimCmd = t, e.ace.inVirtualSelectionMode ? e.ace.on("beforeEndOperation", hr) : hr(null, e.ace)
