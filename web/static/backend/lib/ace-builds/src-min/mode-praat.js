define("ace/mode/praat_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        ...
        this.$rules = {
            start: [{
                ...
                regex: "(" + t + ")"
            }, {token: ["support.function", "text"], regex: "((?:" + r + ")\\$?)(\\s*(?::|\\())"}, {
                token: "keyword",
                regex: /(\bfor\b)/,
                next: "for"
                ...
                regex: /(^\s*)(call)(\s+)(\S+)/
            }, {token: "comment", regex: /(^\s*#|;).*$/}, {token: "text", regex: /\s+/}],
            form: [{
            ...
            }, {token: ["keyword", "text"], regex: /(from|to)(\s+\S+\s*)/}, {token: "text", regex: /$/, next: "start"}],
            brokenstring: [{token: ["text", "string"], regex: /(\s*\.{3})([^"]*)/}, {
                token: "string",
                regex: /"/,
                next: "start"
            }]
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./praat_highlight_rules").PraatHighlightRules,
