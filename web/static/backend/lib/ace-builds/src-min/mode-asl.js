define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"), i = e("./doc_comment_highlight_rules").DocCommentHighlightRules,
        s = e("./text_highlight_rules").TextHighlightRules, o = function () {
            var e = "Default|DefinitionBlock|Device|Method|Else|ElseIf|For|Function|If|Include|Method|Return|Scope|Switch|Case|While|Break|BreakPoint|Continue|NoOp|Wait",
                ...
                o = "__FILE__|__PATH__|__LINE__|__DATE__|__IASL__", u = "Memory24|Processor", a = this.createKeywordMapper({
                    keyword: e,
                    "keyword.operator": t,
                    "function.buildin": n,
                    "constant.language": o,
            ...
            this.$rules = {
                start: [{token: "comment", regex: "\\/\\/.*$"}, i.getStartRule("doc-start"), {
                    ...
                    regex: "\\/\\*",
                    next: "comment"
                }, i.getStartRule("doc-start"), {token: "comment", regex: "\\[", next: "ignoredfield"}, {
                    token: "variable",
                ...
                ignoredfield: [{token: "comment", regex: "\\]", next: "start"}, {defaultToken: "comment"}],
                directive: [{token: "constant.other.multiline", regex: /\\/}, {
                    token: "constant.other.multiline",
                    regex: /.*\\/
                }, {token: "constant.other", regex: "\\s*<.+?>*s", next: "start"}, {
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./asl_highlight_rules").ASLHighlightRules,
