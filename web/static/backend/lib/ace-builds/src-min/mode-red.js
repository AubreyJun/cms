define("ace/mode/red_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        ...
        this.$rules = {
            ...
            string: [{token: "string", regex: /"/, next: "start"}, {defaultToken: "string"}],
            "string.other": [{token: "string.other", regex: /}/, next: "start"}, {defaultToken: "string.other"}],
            tag: [{token: "string.tag", regex: />/, next: "start"}, {defaultToken: "string.tag"}],
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./red_highlight_rules").RedHighlightRules,
        o = e("./folding/cstyle").FoldMode, u = e("./matching_brace_outdent").MatchingBraceOutdent,
