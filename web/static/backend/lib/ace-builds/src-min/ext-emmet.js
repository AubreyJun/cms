define("ace/snippets", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/lang", "ace/range", "ace/anchor", "ace/keyboard/hash_handler", "ace/tokenizer", "ace/lib/dom", "ace/editor"], function (e, t, n) {
    ...
    t.commands = new r, t.runEmmetCommand = function v(e) {
        try {
            h.setupContext(e);
            var n = a.actions || a.require("actions");
            if (this.action == "expand_abbreviation_with_tab") {
                if (!e.selection.isEmpty()) return !1;
                var r = e.selection.lead, i = e.session.getTokenAt(r.row, r.column);
                if (i && /\btag\b/.test(i.type)) return !1
            }
            if (this.action == "wrap_with_abbreviation") return setTimeout(function () {
                n.run("wrap_with_abbreviation", h)
            }, 0);
            var s = n.run(this.action, h)
        } catch (o) {
            if (!a) return t.load(v.bind(this, e)), !0;
            e._signal("changeStatus", typeof o == "string" ? o : o.message), console.log(o), s = !1
        }
        return s
    };
    ...
    t.load = function (e) {
        typeof f == "string" && u.loadModule(f, function () {
            f = null, e && e()
        })
