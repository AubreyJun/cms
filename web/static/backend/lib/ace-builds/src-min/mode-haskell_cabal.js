define("ace/mode/haskell_cabal_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    r.inherits(o, i), function () {
        this.isHeading = function (e, t) {
            var n = "markup.heading", r = e.getTokens(t)[0];
            ...
            if (this.isHeading(e, n)) {
                while (++n < o) if (this.isHeading(e, n)) {
                    n--;
                    break
                }
                a = n;
                ...
                var a = n, f = e.getLine(a).length;
                while (--n >= 0) if (this.isHeading(e, n)) break;
                var r = e.getLine(n), i = r.length;
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./haskell_cabal_highlight_rules").CabalHighlightRules,
        o = e("./folding/haskell_cabal").FoldMode, u = function () {
