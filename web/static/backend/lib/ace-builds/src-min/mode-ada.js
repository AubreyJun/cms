define("ace/mode/ada_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./ada_highlight_rules").AdaHighlightRules,
    ...
    r.inherits(u, i), function () {
        this.lineCommentStart = "--", this.getNextLineIndent = function (e, t, n) {
            ...
            var r = t.getLine(n), i = t.getLine(n - 1), s = this.$getIndent(i).length, u = this.$getIndent(r).length;
            if (u <= s) return;
