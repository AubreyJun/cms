define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"), i = e("../lib/lang"), s = e("./doc_comment_highlight_rules").DocCommentHighlightRules,
        o = e("./text_highlight_rules").TextHighlightRules, u = function () {
            function t(e, t) {
                var n = t.nestable || t.interpolation, r = t.interpolation && t.interpolation.nextState || "start",
                    s = {regex: e + (t.multiline ? "" : "(?=.)"), token: "string.start"}, o = [t.escape && {
                        regex: t.escape,
                ...
                var u = t.interpolation.open, a = t.interpolation.close, f = {
                    regex: "[" + i.escapeRegExp(u + a) + "]", onMatch: function (e, t, n) {
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./swift_highlight_rules").HighlightRules,
