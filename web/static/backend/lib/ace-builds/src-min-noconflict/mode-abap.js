ace.define("ace/mode/abap_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    ...
    var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        ...
        this.$rules = {
            start: [{token: "string", regex: "`", next: "string"}, {
                ...
                regex: "'",
                next: "qstring"
            }, {token: "doc.comment", regex: /^\*.+/}, {token: "comment", regex: /".+$/}, {
                token: "invalid",
                regex: "\\.{2,}"
...
}), ace.define("ace/mode/abap", ["require", "exports", "module", "ace/mode/abap_highlight_rules", "ace/mode/folding/coffee", "ace/range", "ace/mode/text", "ace/lib/oop"], function (e, t, n) {
    "use strict";
    ...
    var r = e("./abap_highlight_rules").AbapHighlightRules, i = e("./folding/coffee").FoldMode, s = e("../range").Range,
        o = e("./text").Mode, u = e("../lib/oop");
