ace.define("ace/ext/menu_tools/get_editor_keyboard_shortcuts", ["require", "exports", "module", "ace/lib/keys"], function (e, t, n) {
    ...
    var r = e("./lib/oop"), i = e("./lib/event_emitter").EventEmitter, s = e("./lib/lang"), o = e("./range").Range,
        u = e("./anchor").Anchor, a = e("./keyboard/hash_handler").HashHandler, f = e("./tokenizer").Tokenizer,
        l = o.comparePoints, c = function () {
    ...
    (function () {
        r.implement(this, i), this.getTokenizer = function () {
            ...
            for (var l = 0; l < o.length; l++) {
                ...
                var v = u[p], m = typeof v.value == "string" ? [v.value] : f(v.value);
            ...
            var w = e.getSelectionRange(), E = e.session.replace(w, b), S = new h(e),
    ...
    (function () {
        this.attach = function (e) {
            ...
            var t = e, n = e.action[0] == "r", r = e.start, i = e.end, s = r.row, o = i.row, u = o - s,
                a = i.column - r.column;
            n && (u = -u, a = -a);
            if (!this.$inChange && n) {
...
}), ace.define("ace/autocomplete", ["require", "exports", "module", "ace/keyboard/hash_handler", "ace/autocomplete/popup", "ace/autocomplete/util", "ace/lib/event", "ace/lib/lang", "ace/lib/dom", "ace/snippets", "ace/config"], function (e, t, n) {
    "use strict";
    var r = e("./keyboard/hash_handler").HashHandler, i = e("./autocomplete/popup").AcePopup,
        s = e("./autocomplete/util"), o = e("./lib/event"), u = e("./lib/lang"), a = e("./lib/dom"),
        f = e("./snippets").snippetManager, l = e("./config"), c = function () {
    ...
    (function () {
        this.$init = function () {
            ...
            this.detach(), this.popup && this.popup.destroy();
            var e = this.popup.container;
            e && e.parentNode && e.parentNode.removeChild(e), this.editor && this.editor.completer == this && this.editor.completer == null, this.popup = null
        }
    }).call(c.prototype), c.for = function (e) {
        return e.completer ? e.completer : (l.get("sharedPopups") ? (c.$shared || (c.$sharedInstance = new c), e.completer = c.$sharedInstance) : (e.completer = new c, e.once("destroy", function (e, t) {
            t.completer.destroy()
        })), e.completer)
    }, c.startCommand = {
        name: "startAutocomplete", exec: function (e) {
            var t = c.for(e);
            t.autoInsert = !1, t.autoSelect = !0, t.showPopup(e), t.cancelContextMenu()
    ...
    r.importCssString(i), n.exports.overlayPage = function (t, n, r) {
        ...
        function o() {
            if (!i) return;
            document.removeEventListener("keydown", s), i.parentNode.removeChild(i), t.focus(), i = null, r && r()
        }

        var i = document.createElement("div");
        return i.style.cssText = "margin: 0; padding: 0; position: fixed; top:0; bottom:0; left:0; right:0;z-index: 9990; background-color: rgba(0, 0, 0, 0.3);", i.addEventListener("click", function () {
            o()
        }), document.addEventListener("keydown", s), n.addEventListener("click", function (e) {
            e.stopPropagation()
        }), i.appendChild(n), document.body.appendChild(i), t.blur(), {close: o}
    }
    ...
    function d(e, t, n, r) {
        function y() {
            var e;
            m.getCursorPosition().row > 0 ? e = E() : e = o.getValue();
            var t = m.getData(m.getRow());
            t && !t.error && (b(), n.onAccept && n.onAccept({value: e, item: t}, o))
        }
        ...
        var o = a();
        o.session.setUndoManager(new f), o.setOption("fontSize", e.getOption("fontSize"));
        var h = i.buildDom(["div", {"class": "ace_prompt_container"}]), v = c(e, h, b);
        h.appendChild(o.container), e.cmdLine = o, o.setValue(t, 1), n.selection && o.selection.setRange({
        ...
        if (n.getCompletions) {
            ...
            m.renderer.setStyle("ace_autocomplete_inline"), m.container.style.display = "block", m.container.style.maxWidth = "600px", m.container.style.width = "100%", m.container.style.marginTop = "3px", m.renderer.setScrollMargin(2, 2, 0, 0), m.autoSelect = !1, m.renderer.$maxLines = 15, m.setRow(-1), m.on("click", function (e) {
                var t = m.getData(m.getRow());
                t.error || (o.setValue(t.value || t.name || t), y(), e.stop())
            }), h.appendChild(m.container), w()
        }
        if (n.$rules) {
            var g = new l(n.$rules);
        ...
        o.commands.bindKeys({
            Enter: y, "Esc|Shift-Esc": function () {
                n.onCancel && n.onCancel(o.getValue(), o), b()
            }, Up: function (e) {
                m.goTo("up"), E()
            }, Down: function (e) {
                m.goTo("down"), E()
            ...
            n.onInput && n.onInput(), w()
        }), o.resize(!0), m.resize(!0), o.focus(), p = {close: b, name: n.name, editor: e}
    }
