ace.define("ace/ext/static_highlight", ["require", "exports", "module", "ace/edit_session", "ace/layer/text", "ace/config", "ace/lib/dom", "ace/lib/lang"], function (e, t, n) {
    "use strict";
    ...
    var r = e("../edit_session").EditSession, i = e("../layer/text").Text,
        ...
        o = e("../config"), u = e("../lib/dom"), a = e("../lib/lang").escapeHTML;
    ...
    var h = function (e, t, n) {
        var r = e.className.match(/lang-(\w+)/), i = t.mode || r && "ace/mode/" + r[1];
        if (!i) return !1;
        var s = t.theme || "ace/theme/textmate", o = "", a = [];
        ...
        h.render(o, i, s, t.firstLineNumber, !t.showGutter, function (t) {
            ...
            for (var i = 0; i < a.length; i += 2) {
                var s = t.session.doc.indexToPosition(a[i]), o = a[i + 1], f = r.children[s.row];
                f && f.appendChild(o)
            }
            n && n()
        })
    ...
    h.render = function (e, t, n, i, s, u) {
        ...
        var a = 1, f = r.prototype.$modes;
        typeof n == "string" && (a++, o.loadModule(["theme", n], function (e) {
            n = e, --a || c()
        }));
        var l;
        return t && typeof t == "object" && !t.getTokenizer && (l = t, t = l.path), typeof t == "string" && (a++, o.loadModule(["mode", t], function (e) {
        ...
        var f = u.getLength(), h = l.createElement("div");
