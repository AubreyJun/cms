ace.define("ace/mode/perl6_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
    "use strict";
    var r = e("../lib/oop"), i = e("./text_highlight_rules").TextHighlightRules, s = function () {
        var e = "my|our|class|role|grammar|is|does|sub|method|submethod|try|default|when|if|elsif|else|unless|with|orwith|without|for|given|proceed|succeed|loop|while|until|repeat|module|use|need|import|require|unit|constant|enum|multi|return|has|token|rule|make|made|proto|state|augment|but|anon|supersede|let|subset|gather|returns|return-rw|temp|BEGIN|CHECK|INIT|END|CLOSE|ENTER|LEAVE|KEEP|UNDO|PRE|POST|FIRST|NEXT|LAST|CATCH|CONTROL|QUIT|DOC",
            ...
            s = this.createKeywordMapper({
                ...
                "support.function": n,
                "keyword.operator": i
            }, "identifier"), o = "[a-zA-Z_][a-zA-Z_0-9:-]*\\b",
            u = {token: "constant.numeric", regex: "0x[0-9a-fA-F]+\\b"},
            a = {token: "constant.numeric", regex: "[+-.]?\\d+(?:(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)?\\b"},
            ...
            v = {token: "variable.language", regex: "\\$[/|!]?|@\\$/"}, m = {
                token: "keyword.operator",
                regex: "=|<|>|\\+|\\*|-|/|~|%|\\?|!|\\^|\\.|\\:|\\,|\u00bb|\u00ab|\\||\\&|\u269b|\u2218"
            }, g = {token: "constant.language", regex: "\ud835\udc52|\u03c0|\u03c4|\u221e"},
            y = {token: "string.quoted.single", regex: "['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']"},
            b = {token: "string.quoted.single", regex: "[<](?:[a-zA-Z0-9 ])*[>]"}, w = {
                token: "string.regexp",
                regex: "[m|rx]?[/](?:(?:\\[(?:\\\\]|[^\\]])+\\])|(?:\\\\/|[^\\]/]))*[/]\\w*\\s*(?=[).,;]|$)"
            };
        this.$rules = {
            start: [{token: "comment.block", regex: "#[`|=]\\(.*\\)"}, {
                token: "comment.block",
                regex: "#[`|=]\\[.*\\]"
                ...
                regex: "(use)(\\s+)((?:" + o + "\\.?)*)"
            }, u, a, f, l, c, h, p, d, v, m, g, {token: "comment", regex: "#.*$"}, {
                token: "lparen",
                regex: "[[({]"
            ...
            }, d, v, {token: "lparen", regex: "{", next: "qqinterpolation"}, {
                token: "string.quoted.double",
                regex: '"',
                next: "start"
            }, {defaultToken: "string.quoted.double"}],
            qqinterpolation: [u, a, f, l, c, h, p, d, v, m, g, y, w, {token: "rparen", regex: "}", next: "qqstring"}],
            block_comment: [{
                token: "comment.doc",
                regex: "^=end +[a-zA-Z_0-9]*",
                next: "start"
            }, {defaultToken: "comment.doc"}],
            qheredoc: [{token: "string.unquoted", regex: "END$", next: "start"}, {defaultToken: "string.unquoted"}],
...
}), ace.define("ace/mode/perl6", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/perl6_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/folding/cstyle"], function (e, t, n) {
    "use strict";
    var r = e("../lib/oop"), i = e("./text").Mode, s = e("./perl6_highlight_rules").Perl6HighlightRules,
    ...
    r.inherits(a, i), function () {
        this.lineCommentStart = "#", this.blockComment = [{
            ...
            lineStartOnly: !0
        }, {start: "=item", end: "=end", lineStartOnly: !0}], this.getNextLineIndent = function (e, t, n) {
