    ...
    (function () {
        ...
        this.renderOptionControl = function (key, option) {
            ...
            if (option.type == "buttonBar") {
                ...
                control = ["input", {
                    type: "number", value: value || option.defaultValue, style: "width:3em", oninput: function () {
                ...
                control = ["select", {
                    id: key, value: value, onchange: function () {
                ...
                control = ["input", {
                    type: "checkbox", id: key, checked: value || null, onchange: function () {
