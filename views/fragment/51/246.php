                ...
                <article class="portfolio-item pf-<?php echo $object['object']['catalogId']; ?>">
                    <div class="portfolio-image">
                        <a href="portfolio-single.html">
                            <img src="<?php echo $this->context->getImg($object['prop']['image_url']); ?>" alt="<?php echo $object['object']['title']; ?>">
                        </a>
                        <div class="portfolio-overlay">
                            <a href="<?php echo $this->context->getImg($object['prop']['image_url']); ?>" class="center-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
                        </div>
                    </div>
