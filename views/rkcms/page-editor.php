            ...
            <ul class="sf-js-enabled" style="touch-action: pan-y;">
                <li class="sub-menu"><a href="index.html" class="sf-with-ul"><div>Home</div></a>
                    <ul style="display: none;">
                        <li class="sub-menu"><a href="index-corporate.html" class="sf-with-ul"><div>Home - Corporate</div></a>
                            <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="index-portfolio.html" class="sf-with-ul"><div>Home - Portfolio</div></a>
                            <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="index-blog.html" class="sf-with-ul"><div>Home - Blog</div></a>
                            <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="index-shop.html" class="sf-with-ul"><div>Home - Shop</div></a>
                            <ul style="display: none;">
                                <li><a href="index-shop.html"><div>Shop - Layout 1</div></a></li>
                                <li><a href="index-shop-2.html"><div>Shop - Layout 2</div></a></li>
                            </ul>
                        </li>
                        <li class="sub-menu"><a href="index-magazine.html" class="sf-with-ul"><div>Home - Magazine</div></a>
                            <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="landing.html" class="sf-with-ul"><div>Home - Landing Page</div></a>
                            <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="index-fullscreen-image.html" class="sf-with-ul"><div>Home - Full Screen</div></a>
                            <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="index-onepage.html" class="sf-with-ul"><div>Home - One Page</div></a>
                            <ul style="display: none;">
                ...
                <li class="sub-menu"><a href="#" class="sf-with-ul"><div>Features</div></a>
                    <ul style="display: none;">
                        <li class="sub-menu"><a href="#" class="sf-with-ul"><div><i class="icon-stack"></i>Sliders</div></a>
                            <ul style="display: none;">
                                <li class="sub-menu"><a href="slider-revolution.html" class="sf-with-ul"><div>Revolution Slider</div></a>
                                    <ul style="display: none;">
                                ...
                                <li class="sub-menu"><a href="slider-canvas.html" class="sf-with-ul"><div>Canvas Slider</div></a>
                                    <ul style="display: none;">
                                ...
                                <li class="sub-menu"><a href="slider-flex.html" class="sf-with-ul"><div>Flex Slider</div></a>
                                    <ul style="display: none;">
                                        <li><a href="slider-flex.html"><div>Default Layout</div></a></li>
                                        <li><a href="slider-flex-thumbs.html"><div>with Thumbs</div></a></li>
                                    </ul>
                                </li>
                                <li class="sub-menu"><a href="slider-owl.html" class="sf-with-ul"><div>Owl Slider</div></a>
                                    <ul style="display: none;">
                                ...
                                <li class="sub-menu"><a href="static-parallax.html" class="sf-with-ul"><div>Static Media</div></a>
                                    <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="widgets.html" class="sf-with-ul"><div><i class="icon-gift"></i>Widgets</div></a>
                            <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="#" class="sf-with-ul"><div><i class="icon-umbrella"></i>Headers</div></a>
                            <ul style="display: none;">
                                ...
                                <li class="sub-menu"><a href="header-semi-transparent.html" class="sf-with-ul"><div>Semi Transparent</div></a>
                                    <ul style="display: none;">
                                ...
                                <li class="sub-menu"><a href="header-side-left.html" class="sf-with-ul"><div>Left Side Header</div></a>
                                    <ul style="display: none;">
                                ...
                                <li class="sub-menu"><a href="header-side-right.html" class="sf-with-ul"><div>Right Side Header</div></a>
                                    <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="side-panel.html" class="sf-with-ul"><div><i class="icon-line-layout"></i>Side Panel</div></a>
                            <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="#" class="sf-with-ul"><div><i class="icon-align-justify2"></i>Menu Styles</div></a>
                            <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="#" class="sf-with-ul"><div><i class="icon-ok-sign"></i>Page Titles</div></a>
                            <ul style="display: none;">
                                ...
                                <li class="sub-menu"><a href="page-title-parallax.html" class="sf-with-ul"><div>Parallax Background</div></a>
                                    <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="contact.html" class="sf-with-ul"><div><i class="icon-envelope-alt"></i>Contact Pages</div></a>
                            <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="#footer" data-scrollto="#footer" class="sf-with-ul"><div><i class="icon-th"></i>Footers</div></a>
                            <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="#" class="sf-with-ul"><div><i class="icon-calendar3"></i>Events</div></a>
                            <ul style="display: none;">
                                <li><a href="events-calendar.html"><div>Full Width Calendar</div></a></li>
                                <li class="sub-menu"><a href="events-list.html" class="sf-with-ul"><div>Events List</div></a>
                                    <ul style="display: none;">
                                ...
                                <li class="sub-menu"><a href="event-single.html" class="sf-with-ul"><div>Single Event</div></a>
                                    <ul style="display: none;">
                                ...
                                <li class="sub-menu"><a href="event-single-full-width-image.html" class="sf-with-ul"><div>Single Event - Full</div></a>
                                    <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="modal-onload.html" class="sf-with-ul"><div><i class="icon-line-expand"></i>Modal OnLoad</div></a>
                            <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="coming-soon.html" class="sf-with-ul"><div><i class="icon-time"></i>Coming Soon</div></a>
                            <ul style="display: none;">
                ...
                <li class="mega-menu sub-menu"><a href="#" class="sf-with-ul"><div>Pages</div></a>
                    <div class="mega-menu-content style-2 clearfix" style="display: none; width: 1289px;">
                        <ul class="mega-menu-column col-lg-3" style="">
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Introduction</div></a>
                                <ul style="display: none;">
                        ...
                        <ul class="mega-menu-column col-lg-3" style="">
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Utility</div></a>
                                <ul style="display: none;">
                        ...
                        <ul class="mega-menu-column col-lg-3" style="">
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Layout Grids</div></a>
                                <ul style="display: none;">
                        ...
                        <ul class="mega-menu-column col-lg-3" style="">
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Miscellaneous</div></a>
                                <ul style="display: none;">
                ...
                <li class="mega-menu sub-menu"><a href="#" class="sf-with-ul"><div>Portfolio</div></a>
                    <div class="mega-menu-content style-2 clearfix" style="display: none; width: 1289px;">
                        <ul class="mega-menu-column col-5" style="">
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Grids</div></a>
                                <ul style="display: none;">
                        ...
                        <ul class="mega-menu-column col-5" style="">
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Masonry</div></a>
                                <ul style="display: none;">
                        ...
                        <ul class="mega-menu-column col-5" style="">
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Loading Styles</div></a>
                                <ul style="display: none;">
                        ...
                        <ul class="mega-menu-column col-5" style="">
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Single Project</div></a>
                                <ul style="display: none;">
                        ...
                        <ul class="mega-menu-column col-5" style="">
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Layouts</div></a>
                                <ul style="display: none;">
                ...
                <li class="mega-menu sub-menu"><a href="#" class="sf-with-ul"><div>Blog</div></a>
                    <div class="mega-menu-content style-2 clearfix" style="width: 1289px; display: none;">
                        <ul class="mega-menu-column col-lg-3" style="">
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Default</div></a>
                                <ul style="display: none;">
                            ...
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Timeline</div></a>
                                <ul style="display: none;">
                        ...
                        <ul class="mega-menu-column col-lg-3" style="">
                            ...
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Grid</div></a>
                                <ul style="display: none;">
                        ...
                        <ul class="mega-menu-column col-lg-3" style="">
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Small Thumbs</div></a>
                                <ul style="display: none;">
                            ...
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Item Splitting</div></a>
                                <ul style="display: none;">
                        ...
                        <ul class="mega-menu-column col-lg-3" style="">
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Single</div></a>
                                <ul style="display: none;">
                            ...
                            <li class="mega-menu-title sub-menu"><a href="#" class="sf-with-ul"><div>Comments Module</div></a>
                                <ul style="display: none;">
                ...
                <li class="sub-menu"><a href="shop.html" class="sf-with-ul"><div>Shop</div></a>
                    <ul style="display: none;">
                        ...
                        <li class="sub-menu"><a href="shop-3.html" class="sf-with-ul"><div>3 Columns</div></a>
                        ...
                        <li class="sub-menu"><a href="shop-2.html" class="sf-with-ul"><div>2 Columns</div></a>
                            <ul class="menu-pos-invert" style="display: none;">
                        ...
                        <li class="sub-menu"><a href="shop-1.html" class="sf-with-ul"><div>1 Columns</div></a>
                            <ul class="menu-pos-invert" style="display: none;">
                        ...
                        <li class="sub-menu"><a href="shop-single.html" class="sf-with-ul"><div>Single Product</div></a>
                            <ul class="menu-pos-invert" style="display: none;">
                ...
                <li class="current mega-menu sub-menu"><a href="#" class="sf-with-ul"><div>Shortcodes</div></a>
