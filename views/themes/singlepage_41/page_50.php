...
<header id="header" class="fixed-top">
    <div class="container">
        ...
        <div class="logo float-left">
            ...
            <a href="#intro" class="scrollto"><img src="themes/singlepage/img/logo.png" alt="" class="img-fluid"></a>
        </div>
...
<section id="intro" class="clearfix">
    <div class="container">
        ...
        <div class="intro-img">
            <img src="themes/singlepage/img/intro-img.svg" alt="" class="img-fluid">
        </div>
        ...
        <div class="container">
            ...
            <div class="row about-container">
                ...
                <div class="col-lg-6 background order-lg-2 order-1 wow fadeInUp">
                    <img src="themes/singlepage/img/about-img.svg" class="img-fluid" alt="">
                </div>
            </div>
            <div class="row about-extra">
                <div class="col-lg-6 wow fadeInUp">
                    <img src="themes/singlepage/img/about-extra-2.svg" class="img-fluid" alt="">
                </div>
            ...
            <div class="row portfolio-container">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        <img src="themes/singlepage/img/portfolio/app1.jpg" class="img-fluid" alt="">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.1s">
                    <div class="portfolio-wrap">
                        <img src="themes/singlepage/img/portfolio/web3.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app" data-wow-delay="0.2s">
                    <div class="portfolio-wrap">
                        <img src="themes/singlepage/img/portfolio/app2.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <div class="portfolio-wrap">
                        <img src="themes/singlepage/img/portfolio/card2.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.1s">
                    <div class="portfolio-wrap">
                        <img src="themes/singlepage/img/portfolio/web2.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app" data-wow-delay="0.2s">
                    <div class="portfolio-wrap">
                        <img src="themes/singlepage/img/portfolio/app3.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <div class="portfolio-wrap">
                        <img src="themes/singlepage/img/portfolio/card1.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card" data-wow-delay="0.1s">
                    <div class="portfolio-wrap">
                        <img src="themes/singlepage/img/portfolio/card3.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.2s">
                    <div class="portfolio-wrap">
                        <img src="themes/singlepage/img/portfolio/web1.jpg" class="img-fluid" alt="">
                        <div class="portfolio-info">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="owl-carousel testimonials-carousel wow fadeInUp">
                        ...
                        <div class="testimonial-item">
                            <img src="themes/singlepage/img/testimonial-1.jpg" class="testimonial-img" alt="">
                            <h3>张三</h3>
                            <h4>CEO</h4>
                            <p>
                        ...
                        <div class="testimonial-item">
                            <img src="themes/singlepage/img/testimonial-2.jpg" class="testimonial-img" alt="">
                            <h3>李四</h3>
                            <h4>设计人员</h4>
                            <p>
                        ...
                        <div class="testimonial-item">
                            <img src="themes/singlepage/img/testimonial-3.jpg" class="testimonial-img" alt="">
                            <h3>王五</h3>
                            <h4>店主</h4>
                            <p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp">
                    <div class="member">
                        <img src="themes/singlepage/img/team-1.jpg" class="img-fluid" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="member">
                        <img src="themes/singlepage/img/team-2.jpg" class="img-fluid" alt="">
                        <div class="member-info">
                            <div class="member-info-content">
                                <h4>张三</h4>
                                <span>PHP开发</span>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="member">
                        <img src="themes/singlepage/img/team-3.jpg" class="img-fluid" alt="">
                        <div class="member-info">
                            <div class="member-info-content">
                                <h4>张三</h4>
                                <span>PHP开发</span>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="member">
                        <img src="themes/singlepage/img/team-4.jpg" class="img-fluid" alt="">
                        <div class="member-info">
                            <div class="member-info-content">
                                <h4>张三</h4>
                                <span>PHP开发</span>
            ...
            <div class="row no-gutters clients-wrap clearfix wow fadeInUp">
                ...
                <div class="col-lg-3 col-md-4 col-xs-6">
                    <div class="client-logo">
                        <img src="themes/singlepage/img/clients/client-1.png" class="img-fluid" alt="">
                    </div>
                </div>

                <div class="col-lg-3 col-md-4 col-xs-6">
                    <div class="client-logo">
                        <img src="themes/singlepage/img/clients/client-2.png" class="img-fluid" alt="">
                    </div>
                </div>

                <div class="col-lg-3 col-md-4 col-xs-6">
                    <div class="client-logo">
                        <img src="themes/singlepage/img/clients/client-3.png" class="img-fluid" alt="">
                    </div>
                </div>

                <div class="col-lg-3 col-md-4 col-xs-6">
                    <div class="client-logo">
                        <img src="themes/singlepage/img/clients/client-4.png" class="img-fluid" alt="">
                    </div>
                </div>

                <div class="col-lg-3 col-md-4 col-xs-6">
                    <div class="client-logo">
                        <img src="themes/singlepage/img/clients/client-5.png" class="img-fluid" alt="">
                    </div>
                </div>

                <div class="col-lg-3 col-md-4 col-xs-6">
                    <div class="client-logo">
                        <img src="themes/singlepage/img/clients/client-6.png" class="img-fluid" alt="">
                    </div>
                </div>

                <div class="col-lg-3 col-md-4 col-xs-6">
                    <div class="client-logo">
                        <img src="themes/singlepage/img/clients/client-7.png" class="img-fluid" alt="">
                    </div>
                </div>

                <div class="col-lg-3 col-md-4 col-xs-6">
                    <div class="client-logo">
                        <img src="themes/singlepage/img/clients/client-8.png" class="img-fluid" alt="">
                    </div>
                </div>
...
</main><input type='hidden' id="_csrf" value="<?php echo Yii::$app->request->csrfToken; ?>"/>