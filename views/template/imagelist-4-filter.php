<div class="container clearfix">
    ...
    <ul class="portfolio-filter clearfix" data-container="#portfolio">
        ...
        <li class="activeFilter"><a href="#" data-filter="*">所有</a></li>
    ...
    <div id="portfolio" class="portfolio grid-container clearfix">
        ...
        <article class="portfolio-item pf-media pf-icons">
            <div class="portfolio-image">
                ...
                <div class="portfolio-overlay">
                    <a href="images/portfolio/full/1.jpg" class="left-icon" data-lightbox="image" title="IMage"><i
        ...
        <article class="portfolio-item pf-graphics pf-uielements">
            <div class="portfolio-image">
                ...
                <div class="portfolio-overlay">
                    <a href="https://vimeo.com/89396394" class="left-icon" data-lightbox="iframe"><i
        ...
        <article class="portfolio-item pf-uielements pf-icons">
            <div class="portfolio-image">
                ...
                <div class="portfolio-overlay">
                    <a href="https://www.youtube.com/watch?v=kuceVNBTJio" class="left-icon" data-lightbox="iframe"><i
                                class="icon-line-play"></i></a>
                    <a href="portfolio-single-video.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                </div>
            </div>
        ...
        <article class="portfolio-item pf-graphics pf-media pf-uielements">
            <div class="portfolio-image">
                ...
                <div class="portfolio-overlay">
                    <a href="https://vimeo.com/91973305" class="left-icon" data-lightbox="iframe"><i
                                class="icon-line-play"></i></a>
                    <a href="portfolio-single-video.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
                </div>
            </div>
                ...
                <div class="fslider" data-arrows="false" data-speed="700" data-pause="7000">
                    <div class="flexslider">
                        <div class="slider-wrap">
                            ...
                            <div class="slide"><a href="portfolio-single-gallery.html"><img
                                            src="images/portfolio/4/12-1.jpg" alt="Fixed Aperture"></a></div>
                        </div>
                    </div>
                </div>
                <div class="portfolio-overlay" data-lightbox="gallery">
